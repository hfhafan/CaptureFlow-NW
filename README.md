...
<p align="center">
  <img src="assets/Logo.png" alt="CaptureFlow NW" width="520" />
</p>
...
<p align="center">
  <a href="download/CaptureFlow-NW-v1.2.14-release.apk">
    <img alt="Download APK" src="https://img.shields.io/badge/Download_APK-CaptureFlow_NW_1.2.14-2b6de4?style=for-the-badge" />
  </a>
...
![Setup](assets/setup-screen.png)

### Proyek

![Proyek](assets/project-screen.png)

### Riwayat

![Riwayat](assets/history-screen.png)

### Bantuan dan laporan bug

![Tentang](assets/about-screen.png)

## Download

- APK terbaru: [CaptureFlow-NW-v1.2.14-release.apk](download/CaptureFlow-NW-v1.2.14-release.apk)
- Panduan PDF: [CaptureFlow-panduan-pengguna.pdf](panduan/CaptureFlow-panduan-pengguna.pdf)

## Apa yang baru di 1.2.14

- Delay internal setelah izin screenshot dikurangi agar capture terasa lebih cepat.
- App mengambil bitmap lebih dulu, baru membuat file target di storage.
- Log debug timing ditambah agar bottleneck screenshot lebih mudah dilacak.
